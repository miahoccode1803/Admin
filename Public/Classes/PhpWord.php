...
class PhpWord
{
    ...
    public function __construct()
    {
       ...
       Media::resetElements();
        \PhpOffice\PhpWord\Style::resetStyles();
        \PhpOffice\PhpWord\Settings::setDefaultRtl(null);
        ...
        foreach ($collectionClasses as $collectionClass) {
            $class = 'PhpOffice\\PhpWord\\Collection\\' . $collectionClass;
            $this->collections[$collectionClass] = new $class();
        }
    
        // Metadata
        $metadataClasses = ['DocInfo', 'Settings', 'Compatibility'];
        foreach ($metadataClasses as $metadataClass) {
            $class = 'PhpOffice\\PhpWord\\Metadata\\' . $metadataClass;
            $this->metadata[$metadataClass] = new $class();
        }
    }
