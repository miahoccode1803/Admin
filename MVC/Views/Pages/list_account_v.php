...
<body>
    <form action="http://localhost/meMe/list_account/find" method="POST">
        <div class="khachhang">
                ...
                <tbody class="table-content">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="http://localhost/meMe/list_account/delete/<?php echo $row['username'] ?>"
    ...
    function confirmToggleStatus(username, currentStatus) {
        ...
        if (confirmation) {
            window.location.href = "http://localhost/meMe/list_account/toggleStatus/" + username;
        }
    }

    function confirmDelete(username) {
        if (confirm("Bạn có chắc chắn muốn xóa tài khoản này và tất cả đơn hàng liên quan tới tài khoản này không?")) {
            window.location.href = "http://localhost/meMe/list_account/delete/" + username;
        }
    }
    </script>
</body>
