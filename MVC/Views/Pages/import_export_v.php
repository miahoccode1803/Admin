...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <div class="form-group">
                <form id="importForm" action="http://localhost/webproject/import_export/importData" method="post"
                    ...
                    <button type="submit" class="btn" name="btnImport"><i class="fa fa-upload"></i> Import Data</button>
                </form>
            </div>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <a href="http://localhost/webproject/import_export/exportData/suppliers" class="btn"><i
